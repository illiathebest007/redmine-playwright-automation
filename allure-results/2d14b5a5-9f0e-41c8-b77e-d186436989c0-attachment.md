      ...
      - insertion [ref=e46]:
        - generic [ref=e49]:
          ...
          - link "Keyboard" [ref=e62] [cursor=pointer]:
            ...
            - img [ref=e65]
          - link "Printing & Publishing" [ref=e67] [cursor=pointer]:
            - generic "Printing & Publishing" [ref=e68]
            - img [ref=e70]
          - link "Project Management Software" [ref=e72] [cursor=pointer]:
            - generic "Project Management Software" [ref=e73]
            - img [ref=e75]
...
> 12 |         await searchPage.resultsList.waitFor({ state: 'visible', timeout: 10000 });
     |                                      ^ TimeoutError: locator.waitFor: Timeout 10000ms exceeded.
  13 |         await searchPage.resultsList.first().waitFor({ state: 'visible' });
  14 |         await expect(searchPage.resultsList.first()).toBeVisible();
  15 | 
  16 |     });
  17 | });
```
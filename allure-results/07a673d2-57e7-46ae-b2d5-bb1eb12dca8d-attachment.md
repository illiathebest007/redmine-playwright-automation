    ...
    - generic [ref=e44]:
      - insertion [ref=e46]:
        - generic [ref=e49]:
          ...
          - link "Keyboard" [ref=e52] [cursor=pointer]:
            - generic "Keyboard" [ref=e53]
            - img [ref=e55]
          - link "teclado" [ref=e57] [cursor=pointer]:
            - generic "teclado" [ref=e58]
            - img [ref=e60]
          - link "Computer Keyboards" [ref=e62] [cursor=pointer]:
            - generic "Computer Keyboards" [ref=e63]
            - img [ref=e65]
          - link "database" [ref=e67] [cursor=pointer]:
            - generic "database" [ref=e68]
            - img [ref=e70]
          - link "Printing & Publishing" [ref=e72] [cursor=pointer]:
            - generic "Printing & Publishing" [ref=e73]
            - img [ref=e75]
          - link "Database" [ref=e77] [cursor=pointer]:
            - generic "Database" [ref=e78]
            - img [ref=e80]
          - link "Graphics & Animation Software" [ref=e82] [cursor=pointer]:
            - generic "Graphics & Animation Software" [ref=e83]
            - img [ref=e85]
          - link "Software Utilities" [ref=e87] [cursor=pointer]:
            - generic "Software Utilities" [ref=e88]
            - img [ref=e90]
      - generic [ref=e92]:
...
> 12 |         await searchPage.resultsList.first().waitFor({ state: 'visible', timeout: 5000 });
     |                                              ^ TimeoutError: locator.waitFor: Timeout 5000ms exceeded.
  13 |         //await page.locator('#search-results dt').first().waitFor({ state: 'visible', timeout: 5000 });
  14 |         const resultsCount = await searchPage.resultsList.count();
  15 |         console.log(resultsCount);
  16 |     });
  17 | });
```